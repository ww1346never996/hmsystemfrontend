<template>
    <div>
        <div>
            <el-dialog title="添加入库单" :visible.sync="dialogFormVisible">
                ...
                <div slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click=insertStorageIn>确 定</el-button>
                </div>
            </el-dialog>
        </div>
        <div>
        ...
        <div>
            ...
            <el-button @click="dialogFormVisible = true" type="primary" style="margin-top: 10px">添加入库单</el-button>
        </div>
    </div>
</template>
